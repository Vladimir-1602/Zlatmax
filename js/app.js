(() => {
    ...
    (() => {
        ...
        function menuInit() {
            if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest(".icon-menu")) {
                    ...
                    if (!document.querySelector(".menu-open") && window.innerWidth <= 1200) {
                        document.querySelector(".sub-menu__active") ? document.querySelector(".sub-menu__active").classList.remove("sub-menu__active") : null;
        ...
        function rangeInit() {
            ...
            if (priceSlider) {
                let priceFrom = document.querySelector("[data-from]");
                let priceTo = document.querySelector("[data-to]");
                let rangeItem = document.querySelector("[data-item]");
                ...
                let valuesObj = [ priceFrom, priceTo ];
                rangeItem.noUiSlider.on("update", (function(values, handle) {
                    valuesObj[handle].value = values[handle];
                }));
                valuesObj.forEach((function(input, handle) {
                    input.addEventListener("change", (function() {
                        rangeItem.noUiSlider.setHandle(handle, this.value);
                    }));
                }));
            }
            const priceSlider2 = document.querySelector("[data-range2]");
            if (priceSlider2) {
                let priceFrom2 = document.querySelector("[data-from2]");
                let priceTo2 = document.querySelector("[data-to2]");
                let rangeItem2 = document.querySelector("[data-item2]");
                nouislider.create(rangeItem2, {
                    format: {
                        to: function(value) {
                            return Math.round(value);
                        },
                    ...
                    start: [ +priceFrom2.value, +priceTo2.value ],
                    connect: [ false, true, false ],
                    step: 1,
                    range: {
                        min: [ +priceFrom2.value ],
                        max: [ +priceTo2.value ]
                    }
                });
                let valuesObj2 = [ priceFrom2, priceTo2 ];
                rangeItem2.noUiSlider.on("update", (function(values, handle) {
                    valuesObj2[handle].value = values[handle];
                }));
                valuesObj2.forEach((function(input, handle) {
                    input.addEventListener("change", (function() {
                        rangeItem2.noUiSlider.setHandle(handle, this.value);
                    }));
                }));
            }
            const priceSlider3 = document.querySelector("[data-range3]");
            if (priceSlider3) {
                let priceFrom3 = document.querySelector("[data-from3]");
                let priceTo3 = document.querySelector("[data-to3]");
                let rangeItem3 = document.querySelector("[data-item3]");
                nouislider.create(rangeItem3, {
                    format: {
                        to: function(value) {
                            return Math.round(value);
                        },
                    ...
                    start: [ +priceFrom3.value, +priceTo3.value ],
                    connect: [ false, true, false ],
                    step: 1,
                    range: {
                        min: [ +priceFrom3.value ],
                        max: [ +priceTo3.value ]
                    }
                });
                let valuesObj3 = [ priceFrom3, priceTo3 ];
                rangeItem3.noUiSlider.on("update", (function(values, handle) {
                    valuesObj3[handle].value = values[handle];
                }));
                valuesObj3.forEach((function(input, handle) {
                    input.addEventListener("change", (function() {
                        rangeItem3.noUiSlider.setHandle(handle, this.value);
                    }));
                }));
            }
            const priceSlider4 = document.querySelector("[data-range4]");
            if (priceSlider4) {
                let priceFrom4 = document.querySelector("[data-from4]");
                let priceTo4 = document.querySelector("[data-to4]");
                let rangeItem4 = document.querySelector("[data-item4]");
                nouislider.create(rangeItem4, {
                    format: {
                        to: function(value) {
                            return Math.round(value);
                        },
                    ...
                    start: [ +priceFrom4.value, +priceTo4.value ],
                    connect: [ false, true, false ],
                    step: 1,
                    range: {
                        min: [ +priceFrom4.value ],
                        max: [ +priceTo4.value ]
                    }
                });
                let valuesObj4 = [ priceFrom4, priceTo4 ];
                rangeItem4.noUiSlider.on("update", (function(values, handle) {
                    valuesObj4[handle].value = values[handle];
                }));
                valuesObj4.forEach((function(input, handle) {
                    input.addEventListener("change", (function() {
                        rangeItem4.noUiSlider.setHandle(handle, this.value);
                    }));
                }));
            }
        }
        ...
        function initSliders() {
            if (document.querySelector(".main-slider__slider")) new core(".main-slider__slider", {
                ...
                on: {
                    slideChange: function(swiper) {
                        console.log(swiper);
                        document.querySelector(".main-slider__fraction_active").innerHTML = swiper.realIndex + 1 < 10 ? `0${swiper.realIndex + 1}` : swiper.realIndex + 1;
                    }
                }
            });
            if (document.querySelector(".hits__slider") && window.innerWidth > 700) new core(".hits__slider", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
            ...
            if (document.querySelector(".sales__slider")) new core(".sales__slider", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
            ...
            if (document.querySelector(".sales__slider_2")) new core(".sales__slider_2", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
            ...
            if (document.querySelector(".news__slider_2")) new core(".news__slider_2", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
            ...
            if (document.querySelector(".slider-product__sliders")) {
                const thumbsSwiper = new core(".slider-product__swiper", {
                    modules: [ Thumb ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 4,
                ...
                new core(".slider-product__slider", {
                    modules: [ Thumb ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
            ...
            if (document.querySelector(".likes-product__slider") && window.innerWidth > 700) new core(".likes-product__slider", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
            ...
            if (document.querySelector(".recommend-product__slider") && window.innerWidth > 700) new core(".recommend-product__slider", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
                ...
                simulateTouch: true,
                pagination: {
                    el: ".recommend-product__pagination",
                    clickable: true
                },
                breakpoints: {
                    300: {
        ...
        function actions(event) {
            ...
            const quantityValue = document.querySelector(".actions-info-product__value");
            console.log(quantityValue);
            if (targetElement.closest(".actions-info-product__btn_minus") && +quantityValue.innerHTML >= 1) {
                console.log(quantityValue);
                quantityValue.innerHTML = +quantityValue.innerHTML - 1;
            }
            if (targetElement.closest(".actions-info-product__btn_plus")) quantityValue.innerHTML = +quantityValue.innerHTML + 1;
            if (isMobile.any()) {
                const targetElement = event.target;
                if (targetElement.closest("[data-parent]")) {
                    console.log(targetElement);
                    const menuId = targetElement.dataset.parent;
                    console.log(menuId);
                ...
                if (targetElement.closest(".menu__link_hidden")) {
                    document.querySelector(".menu-open").classList.add("sub-menu__active");
                    event.preventDefault();
                }
                if (targetElement.closest(".return-buttons__close")) {
                    document.querySelector(".sub-menu__active") ? document.querySelector(".sub-menu__active").classList.remove("sub-menu__active") : null;
                    document.querySelector("._sub-menu-active") ? document.querySelector("._sub-menu-active").classList.remove("_sub-menu-active") : null;
                    document.querySelector("._sub-menu-open") ? document.querySelector("._sub-menu-open").classList.remove("_sub-menu-open") : null;
                    document.querySelector(".menu-open") ? document.querySelector(".menu-open").classList.remove("menu-open") : null;
                }
                if (targetElement.closest(".return-buttons__back_b")) {
                    document.querySelector(".sub-menu__active") ? document.querySelector(".sub-menu__active").classList.remove("sub-menu__active") : null;
                    document.querySelector("._sub-menu-active") ? document.querySelector("._sub-menu-active").classList.remove("_sub-menu-active") : null;
                }
                if (targetElement.closest(".return-buttons__back_sub")) {
                    console.log(targetElement);
                    document.querySelector("._sub-menu-open") ? document.querySelector("._sub-menu-open").classList.remove("_sub-menu-open") : null;
                    document.querySelector("._sub-menu-active") ? document.querySelector("._sub-menu-active").classList.remove("_sub-menu-active") : null;
                }
                if (targetElement.closest(".filter__title_all")) {
                    targetElement.classList.toggle("_active");
                    document.querySelector(".filter__items").classList.toggle("_active");
                }
            }
        }
        function sliderFractions() {
            const allFractions = document.querySelector(".main-slider__fraction_all");
            document.querySelector(".main-slider__fraction_active");
            document.querySelectorAll(".main-slider__slide");
            let allFractionsValue = document.querySelectorAll(".main-slider__slide").length;
            if (allFractionsValue > 0) allFractions.innerHTML = allFractionsValue;
        }
        sliderFractions();
        window["FLS"] = true;
        isWebp();
